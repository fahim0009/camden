								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Thank YOU </h1>
											<hr/>
											<p>Hello <?php echo "<b>".$_SESSION["name"]."</b>"; ?>, Your order has been received.
											and your  <?php echo $c_cldl; ?><br/> Time between 
					 <?php echo $c_cdtime; ?><br/></br>A copy of invoice send to your E-mail: <?php echo $c_mail; ?></br>
					 and your Transaction id is: <?php echo $trx_id; ?></b><br/></br>
											you can continue your Shopping <br/></p>
											<a href="http://www.camden.wokandfire.co.uk" class="btn btn-success btn-lg">Continue Shopping</a>
										</div>
...
<!--//mail sent		start			-->
	...
	$from = ' WOK AND FIRE <info@mentosoftware.co.uk>';
