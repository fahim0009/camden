...
$x = $x + 1;
        ...
        echo   
            ...
            '   <input type="hidden" name="return" value="http://victoria.wokandfire.co.uk/payment_success_collection.php?success=1"/>
                <input type="hidden" name="notify_url" value="http://victoria.wokandfire.co.uk/payment_success_collection.php?success=1">
                <input type="hidden" name="cancel_return" value="http://victoria.wokandfire.co.uk/cancel.php"/>
