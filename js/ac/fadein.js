...
fadeimages[0]=["/daan/New Folder/bnr_rotate.gif", "", ""] //plain image syntax
fadeimages[1]=["/daan/New Folder/bnr_rotate.gif", "", ""] //image
fadeimages[2]=["/daan/New Folder/bnr_rotate.gif", "", ""] //image
with link syntax
fadeimages[3]=["photo3.jpg", "", ""]
//image with link and target syntax var fadeimages2=new Array() //2nd
//array set example. Remove or add more sets as needed.
//SET IMAGE PATHS. Extend or contract array as needed
fadeimages2[0]=["photo1.jpg", "", ""] //plain image syntax
fadeimages2[1]=["photo2.jpg", "", ""] //image
with link syntax
fadeimages2[2]=["photo3.jpg", "", ""]
//fadeimages2[2]=["photo3.jpg", "http://www.javascriptkit.com", "_new"]
//image with link and target syntax var fadebgcolor="white"
////NO need to edit beyond here///////////// var fadearray=new Array()
//array to cache fadeshow instances
var fadeclear=new Array() //array to cache corresponding clearinterval
pointers var dom=(document.getElementById) //modern dom browsers
var iebrowser=document.all function fadeshow(theimages, fadewidth,
fadeheight, borderwidth, delay, pause, displayorder){
...
var fadeheight=fadeheight+this.imageborder*2 if
(iebrowser&&dom||dom) //if IE5+ or modern browsers (ie:
Firefox)
...
src="'+this.postimages[0].src+'"></div>') if
(iebrowser&&dom||dom) //if IE5+ or modern browsers such as
Firefox
this.startit()
else{
this.curimageindex++
